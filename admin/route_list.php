        ...
        <div class="offset-md-2 col-md-8 mt-1" >
            ...
            <div class="card" >
                <div class="card-header">
                    <h3><i class="fa fa-list-o"></i>&nbsp;Route List</h3>
                </div>
                       ...
                       // print_r($routes); exit;
                        foreach ($routes as $route){?>
                            ...
                            <tr>
                                ...
                                <td><a href="../admin/edit_route.php?action=edit&id=<?php echo $route->route_id;?>" class="btn btn-primary btn-sm">Edit</a> || <a href="?action=delete&id=<?php echo $route->route_id;?>" onclick="return(confirm('are you sure to delete?'))" class="btn btn-warning btn-sm">Delete</a></td>
                            </tr>
                            <?php $i++;} ?>
                        </tbody>
