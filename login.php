  ...
  <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    ...
    <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="login.php" target="blank"><i class="fa fa-lock"></i>&nbsp;Login</a>
        </li>
...
<div class="container-fluid">
    ...
    <div class="row" style="margin-top: 80px !important;">
        ...
        if (isset($_POST['login']))
        {
            ...
            $statement = $db->pdo->prepare('select * from usertable where username=:username and password=:password');
        ...
        <div class="offset-md-3 col-md-5 mt-1" >
            ...
            <div class="card" >
                <div class="card-header">
                    <h3><i class="fa fa-user"></i>&nbsp;User Login  Panel</h3>
                </div>
                <div class="card-body">
